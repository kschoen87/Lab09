...
\ \\
\includegraphics[width=0.50\textwidth]{images/p2.3.4.png}\\ \textit{Figure 20: Screenshot of test. Five login attempts made to account kali using intentionally incorrect passwords. The sixth attempt was made using the correct password. Lockout is confirmed by continued denied access.}
